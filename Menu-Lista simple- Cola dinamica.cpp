...
void eliminarDatoLista(listaS *&, int);
...
void opcionesLista() {
	...
	SetColor(15);
	gotoxy(10, 8);   cout << "INGRESAR DATOS A LA LISTA";
	gotoxy(10, 9);   cout << "_______________________________";
	gotoxy(10, 10);  cout << "ELIMINAR DATOS DE LA LISTA";
	gotoxy(10, 11);  cout << "_______________________________";
	gotoxy(10, 12);  cout << "REGRESAR AL MENU PRINCIPAL";
	gotoxy(10, 13);  cout << "_______________________________";
...
void listaSimple() {
	...
	do {
		...
		if (tecla == 13) { //tecla enter
			if (y == 8) {
				gotoxy(40, 7); cout << "PARA SALIR DE ESTA OPCION DEL PROGRAMA DIGITE '-1' ";
				do {
					gotoxy(48, 9); cout << "Digite un dato: ";
					gotoxy(63, 9); cin >> dato;
...
void eliminarDatoLista(listaS *&lista, int n) {
	if (lista != NULL) {
		listaS *aux_borrar = NULL;
		...
		if (aux_borrar == NULL) {
			gotoxy(40, 15); cout << "El elemento no existe";
		}
